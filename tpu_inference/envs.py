...
if TYPE_CHECKING:
    ...
    FLASH_SAMPLING_TOPK_THRESHOLD: int = 0
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Use fast top-k top-p sampling when all requests k<=threshold. 0 means disabled.
    "FLASH_SAMPLING_TOPK_THRESHOLD":
    lambda: int(os.getenv("FLASH_SAMPLING_TOPK_THRESHOLD") or "0"),
}
